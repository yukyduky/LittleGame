...
enum class BEHAVIOR {
	GOSTART, GOSTART_HOME, GOOPTIONS, RESUMEGAME, STARTGAME, RESTARTGAME, NEWGAME, 
	VOLUMEUP, VOLUMEDOWN, VOLUMEUP_E, VOLUMEDOWN_E, VOLUMEUP_M, VOLUMEDOWN_M, WINDOWSWITCH,
