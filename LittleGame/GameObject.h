...
namespace OBJECTSTATE {
	enum class TYPE { ACTIVATED, DEAD, FROZEN, ATTACKING, STOP, FALLING, TFALLING, INVISIBLE, RECOVER, RESETCOLOR, GENERATORRISING, GENERATORACTIVE };
}
namespace OBJECTTYPE {
	enum TYPE {
		PLAYER, ENEMY, DOODAD, INDESTRUCTIBLE,
		PROJECTILE, GENERATOR, NOT_SET,
		SIZE
	};
}
